<div id="toast-success"
     class="flex fixed z-50 hidden top-5 right-5 items-center p-4 mb-4 max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
     role="alert">
    <div
