...
@section('content')
    ...
    <div class="flex flex-row px-5 py-3 items-center justify-between align-middle shadow bg-gray-200 dark:bg-gray-700">
        <h2 class="text-xl text-gray-800 dark:text-gray-100 leading-tight">Редактирование показания</h2>
    ...
    <div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div
            ...
            {!! Form::open(['route' => ['indications.update', $indication->id],'method'=>'PATCH']) !!}
            <div>
                <x-label for="name" :value="__('Название')"/>

                <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$indication->name"
                         autofocus/>
            </div>
